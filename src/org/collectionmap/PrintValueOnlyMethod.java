...
public class PrintValueOnlyMethod {
	...
	public static void main(String[] args) {
		...
		Collection<String> values1 = mp1.values();
		System.out.println("Hash Map Values only : " +values1);
		...
		System.out.println("Linked Hash Map Values only : " +values2);
		...
		Collection<Integer> values3 = mp3.values();
		System.out.println("Tree Map Values only : " +values3);
		...
		Collection<String> values4 = mp4.values();
		System.out.println("Hash Table Values only : " +values4);
